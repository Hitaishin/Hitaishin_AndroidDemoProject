...
import com.citimate.adapter.profile.TagListAdapter;
...
public class TagListFragment extends Fragment {
    ...
    private ArrayList<TagListModel> tagListModels;
    ...
    private void setValues() {
        ...
        tagListAdapter = new TagListAdapter(getActivity(), tagListModels);
