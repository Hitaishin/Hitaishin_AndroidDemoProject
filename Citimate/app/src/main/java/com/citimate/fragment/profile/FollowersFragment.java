...
public class FollowersFragment extends Fragment {
    ...
    private int[] userProfile = {R.drawable.ic_image_usere, R.drawable.ic_image_userd, R.drawable.ic_image_userc, R.drawable.ic_image_userb,
            R.drawable.ic_image_usera, R.drawable.balak};
