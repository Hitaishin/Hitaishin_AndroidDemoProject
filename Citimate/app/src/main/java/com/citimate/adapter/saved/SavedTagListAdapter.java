...
public class SavedTagListAdapter extends RecyclerView.Adapter<SavedTagListAdapter.ViewHolder> {

    private ArrayList<SavedTagListModel> listModels;
    private Activity context;

    public SavedTagListAdapter(Activity context, ArrayList<SavedTagListModel> listModels) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_saved_tag_list, parent, false);
